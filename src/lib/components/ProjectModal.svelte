...
{#if open}
	...
	>
		<h2 id="modal-title" class:dark={$darkMode}>Create New Project</h2>

		<label for="pname-input" class:dark={$darkMode}>Project name:</label>
		<input id="pname-input" class:dark={$darkMode} name="pname" type="text" autocomplete="off" required />

		<div class="modal-buttons" class:dark={$darkMode}>
			<button type="submit" class="modal-primary" class:dark={$darkMode}>Create</button>
...
<style>
    :root {
        ...
        --input-border-light: none;
        --input-border-dark: none;
        ...
        --btn-primary-bg-light: linear-gradient(90deg, #a3cef1, #ffcbcb);
        --btn-primary-bg-dark: linear-gradient(90deg, #335c67, #e09f3e);

        --btn-primary-hover-light: linear-gradient(90deg, #c0dbfb, #ffc0c0);
        --btn-primary-hover-dark: linear-gradient(90deg, #4b7a86, #f8c26e);
