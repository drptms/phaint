...
{#if open}
	...
	>
		<h2 id="modal-title">Accept Invitation</h2>

		<label for="pname-input">Link:</label>
		<input id="pname-input" name="invite" type="text" autocomplete="off" required />

		<div class="modal-buttons">
			<button type="submit" class="modal-primary">Accept</button>
